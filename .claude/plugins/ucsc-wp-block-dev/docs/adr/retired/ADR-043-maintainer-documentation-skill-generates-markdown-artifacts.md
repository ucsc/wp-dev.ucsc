...
Superseded by [ADR-045](../ADR-045-maintainer-generate-docs-mode-documentation-reference.md).
...
- `skills/maintainer/assets/ucsc-wp-block-dev-presentation.md` for the slide
  deck source.
