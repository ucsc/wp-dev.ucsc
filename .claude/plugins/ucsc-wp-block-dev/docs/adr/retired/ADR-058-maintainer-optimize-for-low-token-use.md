...
> Superseded 2026-06-24 — consolidated into
> [ADR-003](../ADR-003-maintainer-low-token-use.md) (Low token use and
...
to run single-agent by default rather than orchestrating subagents.
