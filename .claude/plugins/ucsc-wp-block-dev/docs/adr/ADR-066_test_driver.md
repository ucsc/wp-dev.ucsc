...
1. The script is `skills/validate/validate_driver.sh` and takes no subcommands.
...
2026-06-23 review/fix session found `validate_driver.sh` was a PHP-only stub that
