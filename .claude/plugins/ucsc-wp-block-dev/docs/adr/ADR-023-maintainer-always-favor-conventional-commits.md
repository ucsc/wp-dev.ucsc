...
- A known Jira key is referenced in a footer (`Refs: WPM-97`), not stitched into the subject, per [ADR-021](ADR-021-maintainer-accept-jira-id-or-url-in-arguments.md).
