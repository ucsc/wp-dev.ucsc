...
Establish a standardized detailed skill display card format. This format must be utilized by scripts or tools (like `skill_details.py`) when printing detailed logs for a single skill.
