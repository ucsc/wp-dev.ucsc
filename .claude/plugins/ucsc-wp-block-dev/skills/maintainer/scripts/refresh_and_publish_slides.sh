...
#
# Usage:
#   refresh_and_publish_slides.sh              # refresh + test + publish
#   refresh_and_publish_slides.sh --no-publish # refresh + test only (no upload)
...
DECK="$PLUGIN_ROOT/skills/maintainer/assets/ucsc_wp_block_dev_presentation.md"
