<?php
/**
 * seed-demo-page.php — upsert a single "UCSC Block Demo" page whose content is
 ...
 *   docker compose exec -T wpcli wp eval-file - < helpers/seed-demo-page.php
 */
...
foreach ( $names as $name ) {
	if ( $name === 'ucsc/events' ) {
		$content .= "<!-- wp:ucsc/events {\"apiUrl\":\"https://events.ucsc.edu/wp-json/tribe/v1/events\"} /-->\n\n";
	} else {
		$content .= "<!-- wp:{$name} /-->\n\n";
	}
}
